...
OUTPUT_CAM_MAT_FILENAME = "./assets/calibration-data/laptop-cam-mat.npz"
OUTPUT_DIST_COEFF_FILENAME = "./assets/calibration-data/laptop-dist-coeff.npz"
...
def main():
    ...
    # Calibrate camera
    ret, mat, dist, rvecs, tvecs = cv2.calibrateCamera(objpoints, imgpoints, gray_img.shape[::-1], None, None)
