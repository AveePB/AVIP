...
> **Important**: In the final production firmware, we moved away from JSON to a raw binary packet structure to minimize latency and CPU overhead on the Arduino.